# Lifelong-learning - Becoming 1% better at Data Science everyday.
...
- [ ] [Book: Who moved my cheese:  An Amazing Way to Deal with Change in Your Work and in Your Life] (https://www.amazon.co.uk/Who-Moved-My-Cheese-Amazing/dp/0091816971/ref=sr_1_1?dchild=1&keywords=who+moved+my+cheese&qid=1586268212&s=books&sr=1-1)
- [ ] [Book: The 7 habits of Highly Effective People] (https://www.amazon.co.uk/Habits-Highly-Effective-People/dp/0684858398/ref=sr_1_1?crid=18T6PZ2Z09OB3&dchild=1&keywords=the+7+habits+of+highly+effective+people&qid=1586268196&s=books&sprefix=the+7+habits+%2Cstripbooks%2C175&sr=1-1)
...
- [X] [Codecademy: SQL: Table Transformation](https://www.codecademy.com/learn/sql-table-transformation)
- [X] [Codecademy: SQL: Analyzing Business Metrics](https://www.codecademy.com/learn/sql-analyzing-business-metrics)
- [X] [Datacamp: Intro to SQL for Data Science](https://www.datacamp.com/courses/intro-to-sql-for-data-science)
- [X] [Datacamp: Introduction to MongoDB in Python](https://www.datacamp.com/courses/introduction-to-using-mongodb-for-data-science-with-python)
...
- [X] [Datacamp: Applying SQL to Real-World Problems](https://www.datacamp.com/courses/applying-sql-to-real-world-problems)
- [X] [Datacamp: Analyzing Business Data in SQL](https://www.datacamp.com/courses/analyzing-business-data-in-sql)
- [X] [Datacamp: Data-Driven Decision Making in SQL](https://www.datacamp.com/courses/data-driven-decision-making-with-sql)
- [X] [Datacamp: Database Design](https://www.datacamp.com/courses/database-design)
- [ ] [Khan Academy: SQL](https://www.khanacademy.org/computing/computer-programming/sql)
- [ ] [Launch School: Introduction to SQL](https://launchschool.com/books/sql)
- [X] [Treehouse: Using Databases in Python](https://teamtreehouse.com/library/using-databases-in-python)
...
- [X] [Thoughtbot: tmux](https://thoughtbot.com/upcase/tmux)
...
- [X] [Datacamp: Web Scraping in Python](https://www.datacamp.com/courses/web-scraping-with-python)
- [X] [Datacamp: Analyzing IoT Data in Python](https://www.datacamp.com/courses/analyzing-iot-data-in-python)
...
- [X] [Datacamp: Intermediate Data Visualization with Seaborn](https://www.datacamp.com/courses/data-visualization-with-seaborn)
- [ ] [Datacamp: Visualizing Time Series Data in Python](https://www.datacamp.com/courses/visualizing-time-series-data-in-python)
- [X] [Datacamp: Improving Your Data Visualizations in Python](https://www.datacamp.com/courses/improving-your-data-visualizations-in-python)
...
- [X] [Datacamp: Foundations of Predictive Analytics in Python (Part 1)](https://www.datacamp.com/courses/foundations-of-predictive-analytics-in-python-part-1)
- [X] [Datacamp: Foundations of Predictive Analytics in Python (Part 2)](https://www.datacamp.com/courses/foundations-of-predictive-analytics-in-python-part-2)
...
- [X] [Treehouse: Regular expression](https://teamtreehouse.com/library/regular-expressions-in-python)
...
- [X] [Datacamp: Customer Analytics & A/B Testing in Python](https://www.datacamp.com/courses/customer-analytics-ab-testing-in-python)
- [X] [Udacity: A/B Testing](https://www.udacity.com/course/ab-testing--ud257)
- [X] [Udacity: A/B Testing for Business Analysts](https://www.udacity.com/course/ab-testing--ud979)
...
- [X] [Datacamp: Working with Dates and Times in Python](https://www.datacamp.com/courses/working-with-dates-and-times-in-python)
...
- [X] [Treehouse: Python collections](https://teamtreehouse.com/library/python-collections-2)
- [X] [Treehouse: Date and Time](https://teamtreehouse.com/library/dates-and-times-in-python)
- [X] [Treehouse: CSV And JSON](https://teamtreehouse.com/library/csv-and-json-in-python)
- [X] [Treehouse: Functional Programming with Python](https://teamtreehouse.com/library/functional-python)
...
- [X] [Thoughtbot: Regular Expressions](https://thoughtbot.com/upcase/regular-expressions)
...
- [X] [Treehouse: Git Basics](https://teamtreehouse.com/library/git-basics)
...
- [X] [Codecademy: Learn Color Design](https://www.codecademy.com/learn/learn-color-design)
...
- [X] [Datacamp: Preparing for Coding Interview Questions in Python](https://www.datacamp.com/courses/preparing-for-coding-interview-questions-in-python)
...
- [X] [Udacity: Refresh Your Resume](https://www.udacity.com/course/refresh-your-resume--ud243)
- [X] [Udacity: Craft Your Cover Letter](https://www.udacity.com/course/craft-your-cover-letter--ud244)
